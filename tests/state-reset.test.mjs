...
const state = {
  ...
  sessions: 42, attempts: 44, xp: 1800, streak: 5, lastDay: "2026-08-10",
  history: [{day: "2026-08-10", counted: true}],
  customSessions, preferences, measurements,
  goals: [{id: "goal"}], achievements: {first: true},
...
console.log("OK — reset progression : sportif à zéro, données personnelles conservées.");
